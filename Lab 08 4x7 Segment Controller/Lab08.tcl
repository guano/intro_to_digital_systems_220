# 
# Project automation script for Lab08 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Lab08.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "2_4_decoder.v"
   xfile add "abdg.sch"
   xfile add "cef.sch"
   xfile add "mod4.v"
   xfile add "mux.v"
   xfile add "prog_timer.v"
   xfile add "seg4x7.v"
   xfile add "seven_seg2.sch"

   # Set the Top Module as well...
   project set top "seg4x7"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "J:/EE 220 retake/Lab 08 4x7 Segment Controller/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "seg4x7" -process "Generate IBIS Model"
